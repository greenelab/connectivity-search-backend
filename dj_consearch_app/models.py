...
```
python manage.py graph_models --pydot --disable-sort-fields --output=media/models-schema.svg dj_consearch_app
python manage.py graph_models --pydot --disable-sort-fields --output=media/models-schema.png dj_consearch_app
```
