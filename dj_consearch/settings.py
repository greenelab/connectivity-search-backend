"""
Django settings for dj_consearch project.
...
path = os.path.join(BASE_DIR, 'dj_consearch', 'secrets.yml')
...
ROOT_URLCONF = 'dj_consearch.urls'
...
WSGI_APPLICATION = 'dj_consearch.wsgi.application'
